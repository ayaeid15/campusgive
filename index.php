    ...
    <div class="container py-4">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8 mx-auto d-flex flex-column align-items-center">
                <span class="badge badge-category px-3 py-2 rounded-pill mb-3 shadow-sm d-inline-flex align-items-center gap-2">
                ...
                <p class="lead mb-4 text-center mx-auto" style="color: var(--text-muted); line-height: 1.8; max-width: 600px;">
                    مجتمعك الجامعي لتبادل الأدوات والكتب واللوازم الدراسية بكل سهولة. شارك ما لا تحتاجه، وادعم زملاءك في رحلتهم الأكاديمية.
                </p>
                
                <div class="d-flex justify-content-center align-items-center gap-3 flex-wrap">
                    <a href="donations/browse.php" class="btn btn-campus-primary btn-lg px-4 rounded-pill shadow-sm d-inline-flex align-items-center gap-2">
                        <span>تصفح التبرعات</span> <i class="fa-solid fa-book-open"></i>
                    </a>
                    <a href="donations/add.php" class="btn btn-campus-outline btn-lg px-4 rounded-pill d-inline-flex align-items-center gap-2">
...
<!-- Features Section -->
<section class="py-5" style="background: rgba(255, 255, 255, 0.4); border-top: 1px solid rgba(220, 200, 205, 0.4); border-bottom: 1px solid rgba(220, 200, 205, 0.4);">
    <div class="container">
                    ...
                    <div class="card h-100 rounded-4 overflow-hidden shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <div class="card-footer-custom">
                                ...
                                <a href="donations/details.php?id=<?php echo $row['id']; ?>" class="btn btn-campus-outline btn-sm px-3 rounded-pill fw-semibold">التفاصيل</a>
                            </div>
                        </div>
                    </div>
                </div>
